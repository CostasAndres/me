    ...
    <div className="min-h-screen bg-white dark:bg-neutral-950">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <div className="bg-theme-card dark:bg-neutral-900 border border-theme-medium dark:border-neutral-700 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-theme-primary dark:text-white">📋 Resumen</h2>
            <p className="text-theme-secondary dark:text-neutral-300">
          ...
          <div className="bg-theme-card dark:bg-neutral-900 border border-theme-medium dark:border-neutral-700 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-theme-primary dark:text-white">🔧 Prerrequisitos</h2>
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                ...
                <span className="text-theme-secondary dark:text-neutral-300">instalado</span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <span className="text-theme-secondary dark:text-neutral-300">configurada</span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <span className="text-theme-secondary dark:text-neutral-300">(recomendado)</span>
              </li>
              <li className="flex items-center gap-2">
          ...
          <div className="bg-theme-card dark:bg-neutral-900 border border-theme-medium dark:border-neutral-700 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-theme-primary dark:text-white">📦 Instalación de Wrangler CLI</h2>
          ...
          <div className="bg-theme-card dark:bg-neutral-900 border border-theme-medium dark:border-neutral-700 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-theme-primary dark:text-white">🔐 Autenticación en Cloudflare</h2>
            <div className="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto">
          ...
          <div className="bg-theme-card dark:bg-neutral-900 border border-theme-medium dark:border-neutral-700 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-theme-primary dark:text-white">⚙️ Configuración del Proyecto</h2>
            
            <h3 className="text-xl font-semibold mb-3 text-theme-primary dark:text-white">1. Configuración de Next.js para Cloudflare Pages</h3>
            
            <h4 className="text-lg font-semibold mb-2 text-theme-primary dark:text-white">Archivo: next.config.ts</h4>
            <div className="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto">
...
export default nextConfig;`}</pre>
          ...
          <div className="bg-theme-card dark:bg-neutral-900 border border-theme-medium dark:border-neutral-700 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-theme-primary dark:text-white">🚀 Proceso de Despliegue</h2>
            
            <h3 className="text-xl font-semibold mb-3 text-theme-primary dark:text-white">1. Construir la aplicación</h3>
            <div className="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto">
            ...
            <h3 className="text-xl font-semibold mb-3 text-theme-primary dark:text-white mt-8">2. Desplegar en Cloudflare Pages</h3>
            <div className="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto">
          ...
          <div className="bg-theme-card dark:bg-neutral-900 border border-theme-medium dark:border-neutral-700 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-theme-primary dark:text-white">🌐 Configuración de Dominio Personalizado</h2>
            
            <h3 className="text-xl font-semibold mb-3 text-theme-primary dark:text-white">Opción 1: Desde el Dashboard de Cloudflare</h3>
          ...
          <div className="bg-theme-card dark:bg-neutral-900 border border-theme-medium dark:border-neutral-700 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-theme-primary dark:text-white">✨ Ventajas de Cloudflare Pages</h2>
          ...
          <div className="bg-theme-card dark:bg-neutral-900 border border-theme-medium dark:border-neutral-700 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-theme-primary dark:text-white">🔗 URLs del Proyecto</h2>
          ...
          <div className="bg-theme-card dark:bg-neutral-900 border border-theme-medium dark:border-neutral-700 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-theme-primary dark:text-white">📝 Notas Importantes</h2>
          ...
          <div className="bg-theme-card dark:bg-neutral-900 border border-theme-medium dark:border-neutral-700 rounded-lg p-6 mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-theme-primary dark:text-white">📚 Recursos Adicionales</h2>
            <div className="space-y-3">
